...
class AIRuntime:
    ...
    def __init__(self, access_key_id, access_key, model_id):
        self._baseEndpoint = "http://aiip-dev.skcc.com"
    ...
    def get_token(self):
        ...
        url = "http://aiip-dev.skcc.com/api/common/backend/admin/api/keyauth"
...
# endpoint = "http://aiip-dev.skcc.com/api/runtime/ifservice/predict/mdl-58aa2b86-d268-4c2b-889c-6eac2472abf5"
